...
<head>
    ...
    <title>Add Supplier - Book Store Management System</title>
                            ...
                            <div id="userAddFormContainer">
                                <form action="database/add.php" method="POST" class="appForm" enctype="multipart/form-data">
                                    ...
                                    <div class="appFormInputContainer">
                                        ...
                                        <input type="text" class="appFormInput" placeholder="Enter book supplier location..." id="supplier_location" name="supplier_location">
                                    </div>
                                    <div class="appFormInputContainer">
                                        <label for="email">Email</label>
                                        <input type="text" class="appFormInput" placeholder="Enter supplier email..." id="email" name="email">
                                    </div>
                                    <button type="submit"><i class="fa fa-plus"></i> Add Supplier </button>
                                </form>
                                <?php
